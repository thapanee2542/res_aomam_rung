...
class ShowFoodCancel extends StatefulWidget {
  ShowFoodCancel({Key? key}) : super(key: key);

  @override
  _ShowFoodUnconfirmState createState() => _ShowFoodUnconfirmState();
}

class _ShowFoodUnconfirmState extends State<ShowFoodCancel> {
                    ...
                    InkWell(
                      onTap: () {
                        Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (contxt) => ShowInfoFoodCancel(
  ...
  Column iconNoCanceled() {
    return Column(
        ...
        children: [
          ...
          SizedBox(height: 20,),
          Text('No canceled orders',style: TextStyle(color: Colors.grey,fontSize: 18),),
        ],
      );
  }
