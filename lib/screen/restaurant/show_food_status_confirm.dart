...
class ShowFoodConfirm extends StatefulWidget {
  ShowFoodConfirm({Key? key}) : super(key: key);

  @override
  _ShowFoodUnconfirmState createState() => _ShowFoodUnconfirmState();
}

class _ShowFoodUnconfirmState extends State<ShowFoodConfirm> {
...
//function เปลี่ยนarray
                    ...
                    InkWell(
                      onTap: () {
                        Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (contxt) => ShowInfoFoodConfirm(
  ...
  Column iconNoCanceled() {
    return Column(
        ...
        children: [
          ...
          SizedBox(height: 20,),
          Text('No confirmed orders',style: TextStyle(color: Colors.grey,fontSize: 18),),
        ],
      );
  }
  ...
  Future<Null> loadOrderFood() async {
    ...
    String orderfoodStatus = 'confirm';
    var url =
