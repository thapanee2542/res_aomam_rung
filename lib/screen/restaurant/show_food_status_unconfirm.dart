...
class ShowFoodUnconfirm extends StatefulWidget {
  ShowFoodUnconfirm({Key? key}) : super(key: key);

  @override
  _ShowFoodUnconfirmState createState() => _ShowFoodUnconfirmState();
}

class _ShowFoodUnconfirmState extends State<ShowFoodUnconfirm> {
...
//function เปลี่ยนarray
                      ...
                      onTap: () {
                        Navigator.of(context)
                            .push(MaterialPageRoute(
                                builder: (contxt) => ShowInfoFoodUncomfirm(
  ...
  Column iconNoCanceled() {
    return Column(
        ...
        children: [
          ...
          SizedBox(height: 20,),
          Text('No unconfirmed orders',style: TextStyle(color: Colors.grey,fontSize: 18),),
        ],
      );
  }
  ...
  Future<Null> loadOrderFood() async {
    ...
    String orderfoodStatus = 'unconfirmed';
    var url =
