...
class ShowInfoFoodCompleted extends StatefulWidget {
  final OrderFoodModel? orderFoodModel;
  ShowInfoFoodCompleted({Key? key, this.orderFoodModel}) : super(key: key);

  @override
  _ShowInfoFoodCompletedState createState() => _ShowInfoFoodCompletedState();
}

class _ShowInfoFoodCompletedState extends State<ShowInfoFoodCompleted> {
