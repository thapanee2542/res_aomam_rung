...
class ShowInfoFoodUncomfirm extends StatefulWidget {
  final OrderFoodModel? orderFoodModel;
  ShowInfoFoodUncomfirm({Key? key, this.orderFoodModel}) : super(key: key);

  @override
  _ShowInfoFoodUncomfirmState createState() => _ShowInfoFoodUncomfirmState();
}

class _ShowInfoFoodUncomfirmState extends State<ShowInfoFoodUncomfirm> {
      ...
      onPressed: () {
        showDialog(
          ...
          builder: (_) => ProsteDialog(
            ...
            content: Text(
                'Are you sure to confirm order food No. ${orderFoodModel!.id}'),
