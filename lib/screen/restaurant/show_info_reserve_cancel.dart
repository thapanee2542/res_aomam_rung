...
class ShowInfoCancel extends StatefulWidget {
  final ReserveDetailsModel? reserveDetailsModel;

  ShowInfoCancel({Key? key, this.reserveDetailsModel}) : super(key: key);

  @override
  _ShowInfoConfirmState createState() => _ShowInfoConfirmState();
}

class _ShowInfoConfirmState extends State<ShowInfoCancel> {
...
//function เปลี่ยนarray
            ...
            child: Padding(
                ...
                child: SingleChildScrollView(
                  child: Column(
                    ...
                    children: [
                      Center(
                        child: Icon(Icons.error_outlined,color: Colors.red,size: 40,),
                      ),
                      Center(child: Text('Cancel',style: TextStyle(fontSize: 16,color: Colors.red,fontWeight: FontWeight.bold),)),
                      Center(
                          child: Text(
  ...
  // ElevatedButton buttonEditOrder() {
