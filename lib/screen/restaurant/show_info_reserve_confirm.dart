...
class ShowInfoConfirm extends StatefulWidget {
  final ReserveDetailsModel? reserveDetailsModel;

  ShowInfoConfirm({Key? key, this.reserveDetailsModel}) : super(key: key);

  @override
  _ShowInfoConfirmState createState() => _ShowInfoConfirmState();
}

class _ShowInfoConfirmState extends State<ShowInfoConfirm> {
                ...
                child: SingleChildScrollView(
                  child: Column(
                    ...
                    children: [
                      ...
                      Center(child: Text('Confirm',style: TextStyle(fontSize: 16,color: Colors.green,fontWeight: FontWeight.bold),)),
                      Center(
                          child: Text(
