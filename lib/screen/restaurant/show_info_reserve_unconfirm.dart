...
class ShowInfoReserve extends StatefulWidget {
  final ReserveDetailsModel? reserveDetailsModel;

  ShowInfoReserve({Key? key, this.reserveDetailsModel}) : super(key: key);

  @override
  _ShowInfoReserveState createState() => _ShowInfoReserveState();
}

class _ShowInfoReserveState extends State<ShowInfoReserve> {
    ...
    return ElevatedButton(
      ...
      onPressed: () {
        showModalBottomSheet(
            ...
            context: context,
            builder: (BuildContext context) => ShowCancelPage(
                  reserveDetailsModel: reserveDetailsModel,
                ));
      },
      child: Text(
        ...
        showDialog(
            ...
            builder: (BuildContext context) {
              return AlertDialog(
                ...
                content: Text(
                    'Are you sure to confirm order reservation No. ${reserveDetailsModel!.reservationId}'),
                actions: [
                  // The "No" button
                  TextButton(
                    onPressed: () {
