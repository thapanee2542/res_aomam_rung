...
import 'package:flutter_rrs_app/screen/restaurant/show_info_reserve_cancel.dart';
...
class ShowCancel extends StatefulWidget {
  ShowCancel({Key? key}) : super(key: key);

  @override
  _ShowCancelState createState() => _ShowCancelState();
}
...
class _ShowCancelState extends State<ShowCancel> {
  ...
  Future<Null> loadReserveDetail() async {
    ...
    String reservationStatus = 'cancel';
                    ...
                    InkWell(
                      ...
                      onTap: (){
                         Navigator.push(
                                    context,
                                    MaterialPageRoute(
                                        builder: (context) => ShowInfoCancel(
                                              reserveDetailsModel:
                                       ...
                                       mainAxisAlignment: MainAxisAlignment.spaceAround,
                                        children: [
                                          Padding(
                                            ...
                                            child: Text('${reserveDetailsModels[index].name}',style: TextStyle(fontSize: 16,fontWeight: FontWeight.bold),
                                            ),
                                          ),
                                          Row(
                                            children: [
                                            Icon(Icons.call,size: 15,color: Colors.grey,),
                                            SizedBox(width: 5,),
                                            Text('${reserveDetailsModels[index].phonenumber}',style: TextStyle(color: Colors.grey),),
                    
                                          ],),
                                          Row(
                                            children: [
                                              Icon(Icons.chair,size: 20,color: Colors.red,),
                                               SizedBox(width: 5,),
                                              reserveDetailsModels[index].orderfoodId.toString() == '0'? Text(''):
                                              Icon(Icons.dining,size: 20,color: Colors.red,),
                                              SizedBox(width: 10,),
                                                Text(
                                     '${reserveDetailsModels[index].reservationStatus}',style: TextStyle(color: Colors.red,fontWeight: FontWeight.bold),),
                                            ],
                                          )
                                  ...
                                  child: Padding(
                                    ...
                                    child: Row(
                                      children: [
                                        ...
                                        SizedBox(width: 5,),
                                        Text('${reserveDetailsModels[index].reservationDate}'),
                                      ],
                                    ),
                                  ),
                                ),
                                    ...
                                    child: Row(
                                      children: [
                                        Icon(Icons.access_time_outlined,color: Colors.grey[600],),
                                         SizedBox(width: 5,),
                                         Text('${reserveDetailsModels[index].reservationTime.toString().substring(10,15)}')
                                      ],
                                    ),
                                  ),
                                ),
  ...
  Column iconNoReserve() {
    return Column(
        ...
        children: [
          ...
          Text('No canceled reserves',style: TextStyle(color: Colors.grey,fontSize: 18),),
        ],
      );
  }
