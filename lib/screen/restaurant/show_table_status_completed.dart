...
import 'package:flutter_rrs_app/screen/restaurant/show_info_reserve_completed.dart';
...
class ShowCompleted extends StatefulWidget {
  ShowCompleted({Key? key}) : super(key: key);

  @override
  _ShowUnconfirmState createState() => _ShowUnconfirmState();
}

class _ShowUnconfirmState extends State<ShowCompleted> {
                    ...
                    InkWell(
                      onTap: () {
                        Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (context) => ShowInfoCompleted(
                                      reserveDetailsModel:
  ...
  Column iconNoReserve() {
    return Column(
        ...
        children: [
          ...
          Text('No completed reserves',style: TextStyle(color: Colors.grey,fontSize: 18),),
        ],
      );
  }
