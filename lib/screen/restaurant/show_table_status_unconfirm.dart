...
class ShowUnconfirm extends StatefulWidget {
  ShowUnconfirm({Key? key}) : super(key: key);

  @override
  _ShowUnconfirmState createState() => _ShowUnconfirmState();
}

class _ShowUnconfirmState extends State<ShowUnconfirm> {
  ...
  Future<Null> loadReserveDetail() async {
    ...
    String reservationStatus = 'unconfirmed';
                    ...
                    InkWell(
                      ...
                      onTap: (){
                         Navigator.push(
                                    context,
                                    MaterialPageRoute(
                                        builder: (context) => ShowInfoReserve(
                                              reserveDetailsModel:
                                      ...
                                      child: Column(
                                       ...
                                       mainAxisAlignment: MainAxisAlignment.spaceAround,
                                        children: [
                                          ...
                                          Row(
                                            children: [
                                              Icon(Icons.chair,size: 20,color: Colors.green,),
                                              SizedBox(width: 5,),
                                              reserveDetailsModels[index].orderfoodId.toString() == '0'? Text(''):
                                              Icon(Icons.dining,size: 20,color: Colors.green,),
                                              SizedBox(width: 10,),
                                                Text(
  ...
  Column iconNoReserve() {
    return Column(
        ...
        children: [
          ...
          Text('No unconfirmed reserves',style: TextStyle(color: Colors.grey,fontSize: 18),),
        ],
      );
  }
